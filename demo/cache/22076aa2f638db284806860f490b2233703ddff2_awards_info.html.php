...
if ($_smarty_tpl->getCached()->isFresh($_smarty_tpl, array (
  'version' => '5.0.0',
  'unifunc' => 'content_660ea32fc274c0_42963707',
...
function content_660ea32fc274c0_42963707 (\Smarty\Template $_smarty_tpl) {
...
<body>
    ...
    <section id="main" class="wrapper alt">
            <div class="inner">
                <header class="major">
                    <p>歷年成果詳細資訊</p>
                    <h1 id="teamName">隊伍名稱:</h1>
                </header>
                <div class="center">
                    <embed src="" type='application/pdf' style="align-items: center;width:70vw;height:105vw;">
                </div>
            </div>
        </section>
